...
tf.flags.DEFINE_string('X_input_dir', 'data/Cycle/trainA',
                       'X input directory, default: data/Cycle/trainA')
tf.flags.DEFINE_string('Y_input_dir', 'data/Cycle/trainB',
                       'Y input directory, default: data/Cycle/trainB')
tf.flags.DEFINE_string('X_output_file', 'data/tfrecords/X.tfrecords',
                       'X output tfrecords file, default: data/tfrecords/X.tfrecords')
tf.flags.DEFINE_string('Y_output_file', 'data/tfrecords/Y.tfrecords',
                       'Y output tfrecords file, default: data/tfrecords/Y.tfrecords')
