...
class CycleGAN:
  def __init__(self,
    ...
    self.G = Generator('G', self.is_training, ngf=ngf, norm=norm, image_size=image_size, direction='X2Y')
    self.D_Y = Discriminator('D_Y',
        self.is_training, norm=norm, use_sigmoid=use_sigmoid)
    self.F = Generator('F', self.is_training, ngf=ngf, norm=norm, image_size=image_size, direction='Y2X')
